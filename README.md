...
| `/monitor/races?hd=YYYYMMDD` | 当日レース一覧・戦略別の賭金/損益 |
...
ダッシュボード、レース一覧、レース詳細、履歴画面はいずれも戦略名を固定せず、
DB に保存された戦略と `models.strategies.STRATEGIES` に登録された戦略をもとに動的表示する。
...
| **edge_band_flat** | 中庸EV帯の固定賭け | EV 20〜40%・オッズ10〜50倍に絞り、最大2点を100円固定で観測 | 有効 |
| **favorite_overlay_flat** | 高確率オーバーレイ固定賭け | 確率8%以上・EV 5〜40%・オッズ3〜20倍の過熱していない本命寄り候補を最大2点観測 | 有効 |
| **tail_value_probe** | 長穴バリュー観測 | 確率1〜2%・EV 80%以上・オッズ80〜300倍の候補を最大1点100円だけ観測 | 有効 |
| **rank_1_23_45** | 予測順位フォーメーション | 1着確率順の1位を頭固定、2・3位を2着、4・5位を3着にして4点を100円固定で観測 | 有効 |
| **rank_123_box** | 予測上位3艇ボックス | 1着確率順の上位3艇を3連単ボックス6点・各100円で観測 | 有効 |
